...
module ts {
    export function __trustedcast__<T,U>(a: T): U {
        return (<U> (<any> a));
    }

    export function tagNode(node: Node) {
        RT.setTag(node, RT.ClosedType(RT.InterfaceType("Node")));
        return node;
    }

    export function tagType(type: Type) {
        RT.setTag(type, RT.ClosedType(RT.InterfaceType("Type")));
        return type;
    }

    export function tagSymbol(sym: Symbol) {
        RT.setTag(sym, RT.ClosedType(RT.InterfaceType("Symbol")));
        return sym;
    }
    ...
    export function getProperty<T>(map: Map<T>, key: string): T {
        return hasOwnProperty.call(map, key) ? map[key] : <T> undefined;
    }
    ...
    class SymbolC implements Symbol {
    ...
    class SignatureC implements Signature {
        public declaration: SignatureDeclaration;
        public typeParameters: TypeParameter[];
        public parameters: Symbol[];
        public resolvedReturnType: Type;
        public minArgumentCount: number;
        public hasRestParameter: boolean
        public hasStringLiterals: boolean;
    ...
    export var objectAllocator: ObjectAllocator = {
        ...
        getSymbolConstructor: () => SymbolC,
        getTypeConstructor: () => TypeC,
        getSignatureConstructor: () => SignatureC
    }

...
module ts {
    ...
    export interface FunctionDeclaration extends SignatureDeclaration {//Declaration, ParsedSignature {
    ...
    export interface StringLiteralTypeNode extends TypeNode, LiteralExpression {
        //text: string;
    }
    ...
    export interface ObjectLiteral extends Expression, Declaration {
    ...
    export interface VariableStatement extends Statement, Declaration {
    ...
    export interface IntrinsicType extends Type, ApparentType {
    ...
    export interface InterfaceType extends ObjectType, ApparentType {
    ...
    export interface TypeReference extends ObjectType, ApparentType {
    ...
    export interface ResolvedObjectType extends ObjectType, ApparentType {

...
module VERSION {
    export module RayTracer {
        ...
        export class Color {
            ...
            public static multiplyScalar(c1, f) {
                var result = new Color(0, 0, 0);
            ...
            public static divideFactor(c1, f) {
                var result = new Color(0, 0, 0);
        ...
        export class Vector {
            ...
            public static multiplyScalar(v, w) {
        ...
        export class Ray {
            constructor(public position, public direction) {
            }
        ...
        export class Solid extends BaseMaterial {
            constructor(public color, reflection, refraction, transparency, gloss) {
        ...
        export class Chessboard extends BaseMaterial {
            constructor(public colorEven, public colorOdd, reflection, transparency, gloss, public density= 0.5) {
        ...
        export class Sphere {
            constructor(public position, public radius, public material) { }

            public intersect(ray) {
        ...
        export class Plane {
            constructor(public position, public d, public material) {
            }
        ...
        export class Camera {
            ...
            constructor(public position:any = null,
                        public lookAt:any = null,
                        public up:any = null) {

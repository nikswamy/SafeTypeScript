...
interface Array<T> {
    ...
    /**
      ...
      */
    every(callbackfn: (value: T) => boolean, thisArg?: any): boolean;
    ...
    /**
      ...
      * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
      */
    some(callbackfn: (value: T) => boolean, thisArg?: any): boolean;
    ...
    /**
      ...
      * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
      */
    filter(callbackfn: (value: T) => boolean, thisArg?: any): T[];

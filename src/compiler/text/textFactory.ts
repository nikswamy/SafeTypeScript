    ...
    class SubText extends TextBase {
        ...
        public _lineStarts(): number[] {
            if (!this._lazyLineStarts) {
                this._lazyLineStarts = TextUtilities.parseLineStarts({ charCodeAt(index) { return this.charCodeAt(index); }, length: this.length() });
            }
    ...
    class StringText extends TextBase {
        ...
        public _lineStarts(): number[] {
            if (this._lazyLineStarts === null) {
                this._lazyLineStarts = TextUtilities.parseLineStarts(new String(this.source));
            }

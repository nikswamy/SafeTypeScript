...
module TypeScript {
    export var DiagnosticCode = {
        ...
        SEC_Function_return_type: "Safs TS: Expected return type {0}; but computed return type {1}",
        SEC_Object_literal_type_mismatch: "Safs TS: Expected object of type {0}; but got object of type {1}",
        SEC_Projecting_nonexistent_field: "Safs TS: Projecting field '{0}' from a value of type {1} is not safe",
        SEC_Projection_from_non_records: "Safs TS: Projecting a field from a value of non-record type is not safe; got type '{0}'",
        SEC_ElementAccess_from_non_any: "Safs TS: Dynamic field access from a non-any-typed object or with a non-any-typed key is not allowed; type of object is {0}; type of key is {1}",
        SEC_Dynamic_call_with_un_typed_argument: "Safs TS: All arguments in a dynamically-typed call must have type 'any'; some argument here includes a type 'un'",
        SEC_Arity_mismatch: "Safs TS: Function expected {0} arguments but is provided {1}",
        SEC_Argument_type_mismatch: "Safs TS: Function expected an argument of type {0} but given an argument of type {1}",
        SEC_Cannot_apply_a_non_function: "Safs TS: Cannot apply a non-function of type {0}",
        SEC_TypeOf_un: "Safs TS: typeof is not safe on an un-typed value",
        SEC_Variable_not_found: "Safs TS: '{0}' is not in the current scope",
        SEC_Variable_assignment_incompatible_type: "Safs TS: Variable '{0}' of type '{1}' cannot be assigned a value of type '{2}'",
        SEC_Assigning_to_nonexistent_field: "Safs TS: Unsafe assignment; field '{0}' does not exists in a value of type {1}",
        SEC_Assigning_incompatible_value_to_field: "Safs TS: Field '{0}' of type '{1}' cannot be assigned a value of type '{2}'",
        SEC_Assigning_to_immutable_field: "Safs TS: Field '{0}' is immutable",
        SEC_Assigning_to_non_record: "Safs TS: Assigning to a field '{0}' of a non-record value of type '{1}'",
        SEC_Assigning_to_a_non_lvalue: "Safs TS: Assignment to a '{0}' is not allowed; must be either an identifier, member access or element access expression",
        SEC_Dynamic_field_assignment_all_not_any: "Safs TS: All three objects in a dynamic assignment form (o[f]=v) must have type any;got {0}, {1} and {2}",
        SEC_Variable_shadowing: "Safs TS: Multiple declarations of the same variable name within the same scope are not allowed; '{0}' is declared more than once, shadowing a declaration at {1}",
        SEC_Array_element_type: "Safs TS: Expected array element of type {0}; got {1}",
        SEC_Unary_operator_expects_an_un_free_type: "Safs TS: Unary operator expects an un-free argument; got {0}",
        SEC_Binary_operator_expects_both_any: "Safs TS: Binary operator expects both arguments to have type any; got {0} and {1}",
        SEC_Conditional_guard_not_any: "Safs TS: Conditional guard expects type any; got {0}",                                                     
        SEC_Conditional_branch: "Safs TS: This branch was expected to have type {0}; got {1}",
        SEC_Property_iteration_on_non_any: "Safs TS: For-in loops are only permitted on any-typed objects; got {0}",
        SEC_Invalid_lval_iteration: "Safs TS: Invalid iteration variable in for-in loop; {0}",
        SEC_Throw_not_any: "Safs TS: Exception value must have type any; got {0}",
        SEC_Switch_guard_not_primitive: "Safs TS: Switching on non-primitive values is not supported; got a value of type {0}",
        SEC_Switch_case_incompatible: "Safs TS: Type of the switch case does not match the type of the guard; expected {0} got {1}",
        SEC_Increment_operators_only_on_number: "Safs TS: Increment/decrement operators are only available on the number type; got {0}",
        SEC_Invalid_LHS_self_increment: "Safs TS: Invalid LHS for increment/decrement operator",
        SEC_Missing_return: "Safs TS: Missing a 'return' statement on some code paths",
        SEC_Uninitialized_variable: "Safs TS: Variables of type {0} must be initialized",
        SEC_Invalid_extends_clause: "Safs TS: Invalid extends clause; {0}",
        SEC_Invalid_new_target: "Safs TS: 'new' expression expects a class-typed value as the target; got {0}",
        SEC_Arguments_is_a_reserved_name: "Safs TS: 'arguments' is a reserved name in JavaScript; use another name",
        SEC_This_not_in_scope: "Safs TS: 'this' is not in scope",
        SEC_Super_not_in_scope: "Safs TS: 'super' is not in scope",
        SEC_Uninitialized_member: "Safs TS: member '{0}' may not be initialized",
        SEC_Implicit_conversion_from_any: "Safs TS: Implicit conversion from 'any' to '{0}' was applied",
        SEC_Implicit_coercion: "Safs TS: Implicit conversion from '{0}' to '{1}' was applied",
        SEC_Array_index_not_a_number: "Safs TS: Array index not a number; got {0}",
        SEC_Unsafe_assignment: "Safs TS: Type of LHS ({0}) is not compatible with type of RHS ({1})",
        SEC_Assignment_with_op_expects_undotted_arguments: "Safs TS: Assignment with an operator expects both operands to have undotted type; got {0} and {1}",
        SEC_Reserved_name: "Safs TS: {0} is a reserved name",
        SEC_Assignment_with_addition_requires_number_or_string: "Safs TS: Assignment with addition requires number or string; got {0}",
        SEC_Inferred_type_incompatible_with_sound_type: "Safs TS: Inferred type '{0}' is incompatible with the soundly computed type '{1}'",
        SEC_Duplicate_interface_declaration: "Safs TS: Interface '{0}' may be declared more than once",
        SEC_Generic_types_unsupported: "Safs TS: Generic types are as yet unsupported; {0} is generic",
        SEC_Feature_not_supported: "Safs TS: Does not yet support this feature: {0}", 
        SEC_Missing_argument: "Safs TS: Required argument '{0}:{1}' is missing",
        SEC_Module_name_clash: "Safs TS: Module name {0} was previously used for a non-module",
        SEC_Module_overlapping_field: "Safs TS: Module {0} was previously declared to include a {1} field (at location {2})", 
        SEC_Interface_overlapping_field: "Safs TS: Interface {0} was previously declared to include a {1} field", 
        SEC_Delete_operator_expects_any: "Safs TS: Delete operator expects an 'any'-typed argument; got {0}",
        SEC_Delete_operator_expects_member_or_element_access: "Safs TS: Delete operator expects a member- or element-access expression",
        SEC_Unexpected_property_assignment: "Safs TS: Unexpected property assignment in an object literal: {0}",
        SEC_Index_map_key_type_mismatch: "Safs TS: Index map expected a key of type '{0}'; got '{1}'",
        SEC_Index_map_elt_type_mismatch: "Safs TS: Index map expected an element of type '{0}'; got '{1}'", 
        SEC_Interface_declaration_mismatch: "Safs TS: Interface declaration '{0}' has type '{1}' which is inconsistent with '{2}'",
        SEC_Unexpected_type_arguments: "Safs TS: Unexpected type arguments to a mono-type: {0} (Selected overload #{1} but given type arguments {2})", 
        SEC_Unexpected_class_element: "Safs TS: Unexpected class element: {0}",
        SEC_Initializer_may_rely_on_uninitialized_top_level_names: "Safs TS: Initializer may rely on uninitialized top-level variables (function invocation may not be safe for top-level initializers)",
        SEC_Unsafe_circular_dependence_on_variable: "Safs TS: Unsafe circular dependence on variable '{0}' defined at '{1}'",
        SEC_Could_not_infer_type_arguments: "Safs TS: Could not infer type arguments; defaulting to 'any'",

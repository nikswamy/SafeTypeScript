...
module TypeScript {
    ...
    export class SoundType {
        ...
        public isIndexable() { //Will be true for arrays and index-maps
            return false;
        }
        public toRTTI(): AST {  //generate code for building the runtime rep. of this type
        ...
        public callSignature(overload=0): SoundType {
            return null;
        }
        public indexSignature(overload=0): TIndexMap {
            return null;
        }
        public subst(s:Pair<TVar, SoundType>[], decend:boolean) {
            return this;
        }
        public unfold() {
            return this;
    ...
    export class AST implements IASTSpan {
        ...
        public _start: number = 0;//Gross hack by NS, was -1;
        public _end: number = 0;//Gross hack by NS, was -1;
        public _trailingTriviaWidth: number = 0;

        private _astID: number = astID++;

        public inferredType: PullSymbol = null;
    ...
    export class SourceUnit extends AST {
        public rewrittenModuleElements: ISyntaxList2;
    ...
    export class Identifier extends AST implements IASTToken {
        ...
        public structuralEquals(ast: AST, includingPosition: boolean): boolean {
            return super.structuralEquals(ast, includingPosition) &&
                   (ast instanceof Identifier ? this._text === (<Identifier>ast)._text : false);
        }
    }

    export class LiteralExpression extends AST implements IASTToken {
    ...
    export class NumericLiteral extends AST implements IASTToken {
        ...
        public structuralEquals(ast: AST, includingPosition: boolean): boolean {
            if (super.structuralEquals(ast, includingPosition)) {
                var n: NumericLiteral;
                if (ast instanceof NumericLiteral) {
                    n = <NumericLiteral>ast;
    ...
    export class ArrayLiteralExpression extends AST {
        constructor(public expressions: ISeparatedSyntaxList2, public newLineMode:NewLineMode=NewLineMode.None) {
            super();
    ...
    export class InvocationExpression extends AST implements ICallExpression {
        public inferredTypeArgs: PullTypeSymbol[] = null;//Added by NS: 03/17
        public resolvedSignatureIndex: number = 0;
    ...
    export class ArgumentList extends AST {
        constructor(public typeArgumentList: TypeArgumentList, public args: ISeparatedSyntaxList2, public closeParenToken: ASTSpan) {
            super();
            typeArgumentList && (typeArgumentList.parent = this);
            args && (args.parent = this);
        }
    ...
    export class ObjectCreationExpression extends AST implements ICallExpression {
        public inferredTypeArgs: PullTypeSymbol[] = null;
        public resolvedSignatureIndex: number = 0;
        constructor(public expression: AST, public argumentList: ArgumentList) {
            super();
            expression && (expression.parent = this);
    ...
    export class ObjectLiteralExpression extends AST {
        constructor(public propertyAssignments: ISeparatedSyntaxList2, public newLineMode:NewLineMode=NewLineMode.None) {
            super();
    ...
    export class SimplePropertyAssignment extends AST {
        constructor(public propertyName: AST, public expression: AST) {
            super();
            propertyName && (propertyName.parent = this);
            expression && (expression.parent = this);
        }
    ...
    export function diagnosticFromDecl(decl: PullDecl, diagnosticKey: string, args: string[]= null): Diagnostic {
        var span = decl.getSpan();
        return new Diagnostic(decl.fileName(), decl.semanticInfoChain().lineMap(decl.fileName()), span.start(), span.length(), diagnosticKey, args);
    }

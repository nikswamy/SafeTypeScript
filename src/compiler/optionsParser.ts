...
module TypeScript {
    ...
    export class OptionsParser {
        ...
        constructor(public host: IIO, public version: string, public researchVersion: string) {
        }
        ...
        public printVersion() {
            if (!this.printedVersion) {
                ...
                this.host.printLine(getLocalizedText(DiagnosticCode.ResearchVersion_0, [this.researchVersion]));

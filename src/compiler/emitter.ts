...
module TypeScript {
    ...
    export class Emitter {
        ...
        public emitObjectLiteralExpression(objectLiteral: ObjectLiteralExpression) {
            ...
            this.writeToOutput("{");
            this.emitCommaSeparatedList(objectLiteral, objectLiteral.propertyAssignments, /*buffer:*/ " ", /*preserveNewLines:*/ true, /*forceNewLines*/ objectLiteral.newLineMode);
            this.writeToOutput("}");
        ...
        public emitArrayLiteralExpression(arrayLiteral: ArrayLiteralExpression) {
            ...
            // Try to preserve the newlines between elements that the user had.
            this.writeToOutput("[");
            this.emitCommaSeparatedList(arrayLiteral, arrayLiteral.expressions, /*buffer:*/ "", /*preserveNewLines:*/ true, arrayLiteral.newLineMode);
            this.writeToOutput("]");
        ...
        public emitObjectCreationExpression(objectCreationExpression: ObjectCreationExpression) {
            ...
            if (objectCreationExpression.argumentList) {
                ...
                this.writeToOutput("(");
                this.emitCommaSeparatedList(objectCreationExpression.argumentList, objectCreationExpression.argumentList.args, /*buffer:*/ "", /*preserveNewLines:*/ false);
        ...
        private emitCommaSeparatedList(parent: AST, list: ISeparatedSyntaxList2, buffer: string, preserveNewLines: boolean, newLineMode=NewLineMode.None): void {
            if (list === null || list.nonSeparatorCount() === 0) {
                return;
            }
            preserveNewLines = (preserveNewLines && (newLineMode !== NewLineMode.Suppress));
            var forceNewLines = (newLineMode === NewLineMode.Force);
        ...
        public emitScriptElements(sourceUnit: SourceUnit) {
            ...
            var externalModule: PullDecl;
            var temp: number;
            var svModuleName: string;
            if (isExternalModule) {

...
module TypeScript {
    ...
    export function getExtendsHeritageClause(clauses: ISyntaxList2): HeritageClause {
        ...
        return <HeritageClause>clauses.firstOrDefault((a: AST) => {
            ...
            return c.typeNames.nonSeparatorCount() > 0 && c.kind() === SyntaxKind.ExtendsHeritageClause;
        });
    }
    ...
    export function getImplementsHeritageClause(clauses: ISyntaxList2): HeritageClause {
        ...
        return <HeritageClause>clauses.firstOrDefault((a: AST) => {
            var c = <HeritageClause>a;
            return c.typeNames.nonSeparatorCount() > 0 && c.kind() === SyntaxKind.ImplementsHeritageClause;
        });
    }
    ...
    export module Parameters {
        ...
        export function fromParameterList(list: ParameterList): IParameters {
            ...
            return {
                ...
                initializerAt (index: number) {
                    return (<Parameter>list.parameters.nonSeparatorAt(index)).equalsValueClause;
                },
                isOptionalAt (index: number) {
                    return parameterIsOptional(<Parameter>list.parameters.nonSeparatorAt(index));
                }
            }
        }
    }

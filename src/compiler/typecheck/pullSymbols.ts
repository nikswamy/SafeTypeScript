...
module TypeScript {
    ...
    export class PullSymbol {
        ...
        public _translatedSymbol: SoundType = null;
        ...
        private _fullQualifiedName: string [] = null;
        public fullQualifiedName(): string[] {
            if (this._fullQualifiedName) return this._fullQualifiedName;
        ...
        public fullNameAux(scopeSymbol?: PullSymbol): string {
    ...
    export class PullSignatureSymbol extends PullSymbol {
        ...
        public typeParameters: PullTypeSymbol[] = null;
            ...
            if (!this._memberTypeParameterNameCache) {
                ...
                if (this.typeParameters) {
                    for (var i = 0; i < this.typeParameters.length; i++) {
                        this._memberTypeParameterNameCache[this.typeParameters[i].getName()] = <PullTypeParameterSymbol>this.typeParameters[i];
                    }
                }
            }
        ...
        static getSignaturesTypeNameEx(signatures: PullSignatureSymbol[],
            ...
            if (getPrettyTypeName && result.length && len > 1) {
                ...
                var overloadString = getLocalizedText(DiagnosticCode._0_overload_s, [(foundDefinition ? len - 2 : len - 1).toString()]);
    ...
    export class PullTypeSymbol extends PullSymbol {
        ...
        public hasMembers(): boolean {
            ...
            if (this._members && this._members.length !== 0) {// sentinelEmptyArray) {
                return true;
            }
        ...
        private addUnhiddenSignaturesFromBaseType(derivedTypeSignatures: PullSignatureSymbol[], baseTypeSignatures: PullSignatureSymbol[], signaturesBeingAggregated: PullSignatureSymbol[]) {
            ...
            if (!derivedTypeSignatures) {
                RT.applyVariadic<PullSignatureSymbol>(signaturesBeingAggregated, "push", baseTypeSignatures);
        ...
        public getAllMembers(searchDeclKind: PullElementKind, memberVisiblity: GetAllMembersVisiblity): PullSymbol[] {
            ...
            // Add members
            if (this._members.length !== 0) {// != sentinelEmptyArray) {

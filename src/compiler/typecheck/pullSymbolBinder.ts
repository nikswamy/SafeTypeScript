    ...
    export class PullSymbolBinder {
        ...
        private bindVariableDeclarationToPullSymbol(variableDeclaration: PullDecl) {
            ...
            if ((declFlags & PullElementFlags.ImplicitVariable) === 0) {
                ...
                this.semanticInfoChain.setSymbolForAST((<VariableDeclarator>varDeclAST).propertyName, variableSymbol);
        ...
        private bindFunctionDeclarationToPullSymbol(functionDeclaration: PullDecl) {
            ...
            if (functionSymbol) {
                ...
                var isAmbientOrPreviousIsAmbient : boolean = previousIsAmbient || (functionDeclaration.flags & PullElementFlags.Ambient ? true : false);
                var acceptableRedeclaration : boolean = functionSymbol.kind === PullElementKind.Function && (isSignature || functionSymbol.allDeclsHaveFlag(PullElementFlags.Signature)) ||
        ...
        private bindConstructorDeclarationToPullSymbol(constructorDeclaration: PullDecl) {
            ...
            for (var i = 0; i < typeParameters.length; i++) {
                constructSignature.addTypeParameter(<PullTypeParameterSymbol>typeParameters[i]);
            }
